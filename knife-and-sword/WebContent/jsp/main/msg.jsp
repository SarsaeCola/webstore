...
a:hover {color:#FF6600; text-decoration: underline;}
  ...
  <c:choose>
  	<c:when test="${code eq 'success' }">
  		<c:set var="img" value="/imgs/pass.jpeg"/>
  		<c:set var="title" value="成功"/>
  	</c:when>
  	<c:when test="${code eq 'error' }">
  		<c:set var="img" value="/imgs/nopass.jpeg"/>
...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<span style="margin-left: 50px;"><a target="_top" href="<c:url value='/jsp/main/main.jsp'/>">主页</a></span>
	  </div>
	</div>
</div>
